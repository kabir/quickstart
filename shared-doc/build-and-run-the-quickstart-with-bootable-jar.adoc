...
. Depending on which kind of Kafka you would like:
 ...
 b. Set up a Kafka instance on RHOSAK, and connect it to the `reactive-messaging-qs ` application as outlined link:#install_rhosak[earlier]  in this quickstart.
