...
:helmAttributesIncludeFile: ../microprofile-reactive-messaging-kafka/helm-attributes.adoc
:helmS2iGalleonLayersTag: galleonLayers
:helmBuildEnvTag: amqBuildEnv
:helmDeployEnvTag: amqDeployEnv
include::../shared-doc/helm-install.adoc[]
...
[source,subs="attributes+",options="nowrap"]
----
rhoas cluster bind --app-name reactive-messaging-qs  --binding-name kafka-config --yes
----
